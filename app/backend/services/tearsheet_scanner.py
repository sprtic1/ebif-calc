...
HIGHLIGHT_COLORS = [
    ("yellow",  np.array([20, 80, 200]),  np.array([35, 255, 255])),
    ("green",   np.array([35, 60, 180]),  np.array([85, 255, 255])),
    ("blue",    np.array([95, 60, 180]),  np.array([130, 255, 255])),
    ("pink",    np.array([145, 40, 200]), np.array([175, 255, 255])),
    ("purple",  np.array([125, 40, 180]), np.array([155, 255, 255])),
]
